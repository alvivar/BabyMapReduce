...
DROP TABLE bases2.barcelona_listings;

CREATE EXTERNAL TABLE IF NOT EXISTS bases2.barcelona_listings
(
    id STRING,
    listing_url STRING,
    scrape_id STRING,
...
LOAD DATA LOCAL INPATH '/LoadAndSummarize/data/clean_Barcelona_Catalonia_Spain_listings.csv' OVERWRITE INTO TABLE bases2.barcelona_listings;


DROP TABLE IF EXISTS bases2.barcelona_calendar;

CREATE EXTERNAL TABLE IF NOT EXISTS bases2.barcelona_calendar
(
    listing_id STRING,
    date STRING,
    available STRING,
...
LOAD DATA LOCAL INPATH '/LoadAndSummarize/data/clean_Barcelona_Catalonia_Spain_calendar.csv' OVERWRITE INTO TABLE bases2.barcelona_calendar;

...
LOAD DATA LOCAL INPATH '/DEV/BigData-BI/Part2-LoadAndSummarize/data/clean_Montreal_Quebec_Canada_listings.1.csv' OVERWRITE INTO TABLE bases2.montreal_listings;
...
LOAD DATA LOCAL INPATH '/DEV/BigData-BI/Part2-LoadAndSummarize/data/clean_Montreal_Quebec_Canada_calendar.1.csv' OVERWRITE INTO TABLE bases2.montreal_calendar;

...
LOAD DATA LOCAL INPATH '/DEV/BigData-BI/Part2-LoadAndSummarize/data/clean_Cape_Town_Western_Cape_South_Africa_listings.1.csv' OVERWRITE INTO TABLE bases2.cape_town_listings;
...
LOAD DATA LOCAL INPATH '/DEV/BigData-BI/Part2-LoadAndSummarize/data/clean_Cape_Town_Western_Cape_South_Africa_calendar.1.csv' OVERWRITE INTO TABLE bases2.cape_town_calendar;
